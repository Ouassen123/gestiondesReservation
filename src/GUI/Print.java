...
public class Print {
    public Print(String chid, Connection conn){
        ...
        try {
            JasperReport jasperReport = (JasperReport) JRLoader.loadObject(getClass().getResourceAsStream("C:\\Users\\viet\\Documents\\NetBeansProjects\\GestionDuReservation\\src\\GUI\\report2.jasper"));
